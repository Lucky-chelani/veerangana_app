...
Set<Polyline> polylines = {};
  ...
  final String googleApiKey = "AIzaSyCgB0H3PXjukpvtmS5fIhf4kLZFr3jl5KU"; // Replace with your Google API Key
...
Widget build(BuildContext context) {
    ...
    body: Column(
      children: [
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: const [
                      LegendItem(color: Colors.blue, label: "Police Stations"),
          ...
          child: Row(
            ...
            children: [
              ...
              ElevatedButton(
                ...
                child: const Text("Show Hospital Path"),
              ),
            ],
          ),
        ),
        ...
        Expanded(
          child: ListView(
            children: [
              _buildPlaceSection("Nearby Police Stations", policeStations, Colors.blue),
  ...
  Future<void> _fetchNearbyPlaces(LatLng location) async {
    ...
    await _fetchPlacesByType(location, "police", policeStations, BitmapDescriptor.hueBlue);

    // Fetch hospitals
    await _fetchPlacesByType(location, "hospital", hospitals, BitmapDescriptor.hueRed);
  }
  ...
  Widget _buildPlaceSection(String title, List<Map<String, dynamic>> places, Color color) {
              ...
              itemBuilder: (context, index) {
                ...
                return Card(
                  ...
                  child: ListTile(
                    ...
                    subtitle: Text("Distance: ${place['distance'].toStringAsFixed(2)} km"),
                    onTap: () {
